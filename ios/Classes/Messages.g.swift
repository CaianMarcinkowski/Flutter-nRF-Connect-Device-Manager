...
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
protocol DataStoreManagerApi {
  func smpEcho(remoteId: String, message: String, completion: @escaping (Result<FlutterStandardTypedData, Error>) -> Void)
  func smpStats(remoteId: String, groupName: String, completion: @escaping (Result<FlutterStandardTypedData, Error>) -> Void)
  func smpDataStoreGroupRead(remoteId: String, partition: Int64, cell: Int64, completion: @escaping (Result<FlutterStandardTypedData, Error>) -> Void)
  func smpDataStoreGetMetadata(remoteId: String, partition: Int64, completion: @escaping (Result<FlutterStandardTypedData, Error>) -> Void)
  func smpKill(remoteId: String) throws
}

/// Generated setup class from Pigeon to handle messages through the `binaryMessenger`.
class DataStoreManagerApiSetup {
  static var codec: FlutterStandardMessageCodec { MessagesPigeonCodec.shared }
  /// Sets up an instance of `DataStoreManagerApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: DataStoreManagerApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let smpEchoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpEcho\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      smpEchoChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remoteIdArg = args[0] as! String
        let messageArg = args[1] as! String
        api.smpEcho(remoteId: remoteIdArg, message: messageArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      smpEchoChannel.setMessageHandler(nil)
    }
    let smpStatsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpStats\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      smpStatsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remoteIdArg = args[0] as! String
        let groupNameArg = args[1] as! String
        api.smpStats(remoteId: remoteIdArg, groupName: groupNameArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      smpStatsChannel.setMessageHandler(nil)
    }
    let smpDataStoreGroupReadChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGroupRead\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      smpDataStoreGroupReadChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remoteIdArg = args[0] as! String
        let partitionArg = args[1] as! Int64
        let cellArg = args[2] as! Int64
        api.smpDataStoreGroupRead(remoteId: remoteIdArg, partition: partitionArg, cell: cellArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      smpDataStoreGroupReadChannel.setMessageHandler(nil)
    }
    let smpDataStoreGetMetadataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGetMetadata\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      smpDataStoreGetMetadataChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remoteIdArg = args[0] as! String
        let partitionArg = args[1] as! Int64
        api.smpDataStoreGetMetadata(remoteId: remoteIdArg, partition: partitionArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      smpDataStoreGetMetadataChannel.setMessageHandler(nil)
    }
    let smpKillChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpKill\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      smpKillChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let remoteIdArg = args[0] as! String
        do {
          try api.smpKill(remoteId: remoteIdArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      smpKillChannel.setMessageHandler(nil)
    }
  }
}
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
