...
class DataStoreManagerApi {
  ...
  Future<Uint8List> smpEcho(String remoteId, String message) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpEcho$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<Uint8List> smpStats(String remoteId, String groupName) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpStats$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<Uint8List> smpDataStoreGroupRead(String remoteId, int partition, int cell) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGroupRead$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<Uint8List> smpDataStoreGetMetadata(String remoteId, int partition) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGetMetadata$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> smpKill(String remoteId) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpKill$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
