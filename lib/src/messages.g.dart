...
Stream<DownloadCallbackEvent> getFileDownloadEvents({String instanceName = ''}) {
  ...
  final EventChannel getFileDownloadEventsChannel = EventChannel(
    'dev.flutter.pigeon.mcumgr_flutter.McumgrFlutterEvents.getFileDownloadEvents$instanceName',
    pigeonMethodCodec,
  );
...
Stream<ConnectionStateEvent> getConnectionStateEvents({String instanceName = ''}) {
  ...
  final EventChannel getConnectionStateEventsChannel = EventChannel(
    'dev.flutter.pigeon.mcumgr_flutter.McumgrFlutterEvents.getConnectionStateEvents$instanceName',
    pigeonMethodCodec,
  );
...
class DataStoreManagerApi {
  /// Constructor for [DataStoreManagerApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  DataStoreManagerApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<Uint8List> smpEcho(String remoteId, String message) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpEcho$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[remoteId, message]);
  ...
  Future<Uint8List> smpStats(String remoteId, String groupName) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpStats$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[remoteId, groupName]);
    final List<Object?>? pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<Uint8List> smpDataStoreGroupRead(String remoteId, int partition, int cell) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGroupRead$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[remoteId, partition, cell]);
    final List<Object?>? pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<Uint8List> smpDataStoreGetMetadata(String remoteId, int partition) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpDataStoreGetMetadata$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[remoteId, partition]);
    final List<Object?>? pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> smpKill(String remoteId) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.mcumgr_flutter.DataStoreManagerApi.smpKill$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
